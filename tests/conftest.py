...
def test_config():
    ...
    return DataverseConfig(language_code=1033, http_retries=0, http_backoff=0.1, http_timeout=5)
...
def sample_entity_data():
    ...
    return {"name": "Test Account", "telephone1": "555-0100", "websiteurl": "https://example.com"}
