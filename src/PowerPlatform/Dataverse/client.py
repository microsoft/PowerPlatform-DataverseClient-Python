        ...
        Example:
            Create a one-to-many relationship with full control::
                ...
                lookup = LookupAttributeMetadata(
                    ...
                    display_name=Label(
                        localized_labels=[
                            LocalizedLabel(label="Account", language_code=1033)
                        ]
                    ),
                    required_level="None"
                )
                ...
                relationship = OneToManyRelationshipMetadata(
                    schema_name="new_Account_BankAccount",
                    referenced_entity="account",
                    referencing_entity="new_bankaccount",
        ...
        Example:
            Create a many-to-many relationship::
                ...
                relationship = ManyToManyRelationshipMetadata(
                    schema_name="new_contact_new_project",
                    entity1_logical_name="contact",
    ...
    def get_relationship(self, schema_name: str) -> Optional[Dict[str, Any]]:
        ...
        Example:
            Get relationship metadata::
                ...
                rel = client.get_relationship("new_Account_BankAccount")
                if rel:
