...
async def _run_examples(client):
    ...
    try:
        ...
        <fetch>
          <entity name="{project_logical}">
            <attribute name="new_code" />
            <filter><condition attribute="new_code" operator="eq" value="ALPHA" /></filter>
          </entity>
        </fetch>
        """
        ...
        <fetch>
          <entity name="{task_logical}">
            ...
            <filter><condition attribute="new_title" operator="like" value="%test%" /></filter>
          </entity>
        </fetch>
        """
        ...
        <fetch>
          <entity name="{task_logical}">
            <attribute name="new_title" />
            <filter><condition attribute="new_priority" operator="not-null" /></filter>
          </entity>
        </fetch>
        """
