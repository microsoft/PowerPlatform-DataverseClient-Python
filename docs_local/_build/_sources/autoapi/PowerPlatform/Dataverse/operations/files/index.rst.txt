...
.. py:module:: PowerPlatform.Dataverse.operations.files
...
.. autoapisummary::
   ...
   PowerPlatform.Dataverse.operations.files.FileOperations


Module Contents
---------------

.. py:class:: FileOperations(client: PowerPlatform.Dataverse.client.DataverseClient)
   ...
   .. py:method:: upload(table: str, record_id: str, file_column: str, path: str, *, mode: Optional[str] = None, mime_type: Optional[str] = None, if_none_match: bool = True) -> None
